/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4985e318fa73e51959cac3dea75988a6)
...
interface __BaseEnv_Env {
	...
	APP_VERSION: "0.1.0";
	APP_ENVIRONMENT: "staging" | "production" | "local";
	ACCESS_TOKEN_EXPIRE_MINUTES: "60";
	REFRESH_TOKEN_EXPIRE_MINUTES: "10080";
	VOICE_AUDIO_RETENTION_HOURS: "24";
	VOICE_AUDIO_MAX_CHUNK_BYTES: "8388608";
	OPENAI_NORMALIZATION_MODEL: "gpt-5.6-luna";
	POS_IDLE_TIMEOUT_SECONDS: "45";
	POS_SESSION_EXPIRE_HOURS: "12";
	POS_LOGIN_MAX_ATTEMPTS: "5";
	POS_LOGIN_LOCK_MINUTES: "5";
	SECRET_KEY: string;
	AGM_SERVICE: DurableObjectNamespace<import("./worker/index").AGMServiceRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "AGMServiceRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_VERSION" | "APP_ENVIRONMENT" | "ACCESS_TOKEN_EXPIRE_MINUTES" | "REFRESH_TOKEN_EXPIRE_MINUTES" | "VOICE_AUDIO_RETENTION_HOURS" | "VOICE_AUDIO_MAX_CHUNK_BYTES" | "OPENAI_NORMALIZATION_MODEL" | "POS_IDLE_TIMEOUT_SECONDS" | "POS_SESSION_EXPIRE_HOURS" | "POS_LOGIN_MAX_ATTEMPTS" | "POS_LOGIN_LOCK_MINUTES" | "SECRET_KEY">> {}
}
